...
const SRC_MD     = path.resolve(__dirname, '..', 'docs', 'internship_helper.md');
const DEST_HTML  = path.resolve(__dirname, '..', 'docs', 'internship_helper.html');
